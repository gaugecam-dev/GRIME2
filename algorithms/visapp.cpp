...
GC_STATUS VisApp::GetStopsignColor( cv::Scalar &color, double &minRange, double &maxRange )
{
    GC_STATUS retVal = m_calibExec.GetStopsignColor( color, minRange, maxRange );
    return retVal;
}
